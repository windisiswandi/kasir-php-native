            ...
            <form method="get" action="">
              <div class="row">
                ...
                <div class="col-md-2">
                  ...
                  <div class="form-group">
                    <label>Kasir</label>
                    <select class="form-control" name="kasir_data" required="required">
                        <option value="">- Pilih</option>
                    <?php
                        $getDataKasir = mysqli_query($koneksi, "SELECT * FROM kasir");
                        while ($d = mysqli_fetch_assoc($getDataKasir)) : ?>

                        <option value="<?= $d['kasir_id']."-".$d['kasir_nama']; ?>"><?= $d['kasir_nama']; ?></option>
                    <?php endwhile; ?>
                    </select>
                  </div>
        ...
        <div class="box box-info">
          ...
          <div class="box-body">
            ...
            if(isset($_GET['tanggal_sampai']) && isset($_GET['tanggal_dari']) && isset($_GET['kasir_data'])){
              ...
              <a href="laporan_pengeluaran_kasir_print.php?tanggal_dari=<?php echo $tgl_dari ?>&tanggal_sampai=<?php echo $tgl_sampai ?>&kasir_data=<?= $data_kasir; ?>" target="_blank" class="btn btn-sm btn-primary"><i class="fa fa-print"></i> &nbsp PRINT</a>
