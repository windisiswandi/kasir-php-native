                  ...
                  while($d = mysqli_fetch_array($data)){
                    ...
                    <tr>
                      ...
                      <td>                
                        ...
                        <a class="btn btn-danger btn-sm" href="user_hapus.php?id=<?php echo $d['user_id'] ?>" onclick="return confirm('Yakin ingin menghapus admin ini?')"><i class="fa fa-trash"></i></a>
                      </td>
                    </tr>
                    <?php 
                  }
